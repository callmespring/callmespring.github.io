...
I am looking for students interested in LLMs (see our short course [slides](https://github.com/noncollapse/LLM_short_course)), reinforcement learning (see my lecture [slides](https://github.com/callmespring/RL-short-course)) and statistics.  
...
- **Six 2026**:
  ...
  * Talks on [Demystifying LLM through U-statistics theory](./slides/GRPO.pdf) at Oxford, IMS-Asia Pacific Rim Meeting, University of Macau, SUFE, Fudan, ECNU, Tongji University and SUIBE. 
- **May 2026**:
...
* **Large language models**:
  - Reasoning: [Demystify GRPO](https://github.com/callmespring/callmespring.github.io/blob/master/paper/GRPO.pdf) ([slides](https://callmespring.github.io/slides/GRPO.pdf)); [KAE](https://arxiv.org/pdf/2604.28005); [Fin-R1](https://arxiv.org/pdf/2503.16252)
  ...
  - AI-content detection: [AdadetectGPT](https://arxiv.org/pdf/2510.01268) ([talk](https://www.bilibili.com/video/BV1S7K9zwEgU/?spm_id_from=333.337.search-card.all.click)); [L2D](https://arxiv.org/abs/2601.21895); [StatDetectLLM](https://arxiv.org/pdf/2601.06586) ([have a try](https://huggingface.co/spaces/stats-powered-ai/StatDetectLLM)); [DID](https://arxiv.org/pdf/2602.23732); [Change-point-based detection](https://arxiv.org/pdf/2605.03723)
