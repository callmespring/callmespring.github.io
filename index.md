...
My research is motivated from the applications in precision medicine (simulated [STARD](https://cran.r-project.org/web/packages/ITRSelect/index.html) dataset), mobile health (simulated environments for [Diabetes](https://github.com/RunzheStat/TestMDP) and [Intern Health](https://github.com/limengbinggz/cusum-rl)), ridesharing (simulated environments for [Order Dispatch](https://github.com/callmespring/MDPOD) and [Spatio-temporal Policy Evaluation](https://github.com/RunzheStat/CausalMARL)) and neuroscience.
