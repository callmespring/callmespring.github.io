...
Li, T\*., **Shi, C\*.**, Wang, J., Zhou, F. and Zhu, H. (2023). Optimal Treatment Allocation for Efficient Policy Evaluation in Sequential Decision Making, _NeurIPS_. **Python module** [<span style="font-family:courier;">**MDP_design**</span>](https://github.com/tingstat/MDP_design). 
