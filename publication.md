...
Luo, S\*., Yang, Y\*., **Shi, C\*.**, Yao, F., Ye, J. and Zhu, H. (2023+). [Policy Evaluation for Temporal and/or Spatial Dependent Experiments in Ride-sourcing Platforms](https://arxiv.org/pdf/2202.10887.pdf), _Journal of the Royal Statistical Society, Series B_, accepted. **Python module** [<span style="font-family:courier;">**STVCM**</span>](https://github.com/anneyang0060/STVCM).
...
Li, T\*., **Shi, C\*.**, Wang, J., Zhou, F. and Zhu, H. (2023). [Optimal Treatment Allocation for Efficient Policy Evaluation in Sequential Decision Making](https://arxiv.org/pdf/2311.02532.pdf), _NeurIPS_. **Python module** [<span style="font-family:courier;">**MDPdesign**</span>](https://github.com/tingstat/MDP_design). 
